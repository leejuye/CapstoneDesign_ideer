...
echo
Installer_info "Deleting: README.md *.js update recipes resources translations components library ui package.json package-lock.json" 
rm -rf README.md *.js update recipes resources translations components library ui package.json package-lock.json
